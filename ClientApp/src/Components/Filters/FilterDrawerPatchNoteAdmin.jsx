 import {
    Button, Divider, Drawer, DrawerBody, DrawerCloseButton, DrawerContent,
    DrawerFooter, DrawerHeader, DrawerOverlay, Flex, Input, Show,
    Spacer, Stack, Text, useDisclosure
...
import {useAllModulesQuery, useUsersModulesQuery} from "@/services/queries/getAllModules.js";
...
export const FilterDrawerPatchNoteAdmin = ({   activeDatePublication,
    ...
    const { data: listUsersModules } = useUsersModulesQuery(userId);
            ...
            <Drawer onClose={onClose} isOpen={isOpen} size={size}>
                ...
                <DrawerContent>
                    ...
                    <DrawerHeader
                        ...
                        shadow="sm">{t('main.general.filter')}
                    </DrawerHeader>
                    ...
                    <DrawerFooter   bgColor="primaryBlue.5"
                        ...
                        <Flex grow={1}>
                            {/* Poubelle button */}
                            <Button bgColor="white" shadow="sm" onClick={()=> {
                                resetFilters()
                                setTimeout(() => {
                            ...
                            {/* Search button */}  
                            <PrimaryActionButton text={t('main.general.search')} 
                                                onClick={()=> {
                                                    setTimeout(() => {
                                                        queryClient.fetchQuery([
                                                            "articleLoadMore",
