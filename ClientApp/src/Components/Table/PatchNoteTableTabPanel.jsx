...
import {
  tableHeadContentArticles,
  tableHeadContentNewsletters,
} from "@/Datas/tableHeadContent.js";
...
export const PatchNoteTableTabPanel = ({
  ...
  return (
    <Flex flexDirection={"column"} pe={0} ps={0}>
      <Table
        colorScheme="SuppBlue"
        pe={0}
        variant={isLargerThanMd ? "simple" : "unstyled"}
      >
        <Show above={"xl"}>
          <TableHeader
