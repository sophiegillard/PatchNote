               ...
               // Set a cookie with the JWT token from the response
                ...
                signIn({
                    ...
                    authState: {
                        ...
                        ecole: response.data.utilisateur.ecoleAuxiliaire.ecole.nom,
                        ecoleAux: response.data.utilisateur.ecoleAuxiliaire.nom,
                ...
                <Box
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <Stack spacing={4}>
                            ...
                            <Center>
                                <Heading fontSize={'4xl'} textAlign="center">{t('pages.login.login_title')}</Heading>
                            </Center>

                            <Stack>

                                <FormControl id="identifiant" isInvalid={errors.identifiant}>
                                    <FormLabel>{t('pages.login.login_username')}</FormLabel>
                                    <Input type="identifiant" {...register("identifiant", { required: true })} />
                                    {errors.identifiant && <FormErrorMessage>{t('pages.login.login_error')}</FormErrorMessage>}
                                </FormControl>
