    ...
    return <>
        <TabPanel>
            {!isLargerThanMd ? (<Stack>
                ...
                <HStack spacing='6rem'>
                    <TitleAndContent
                        title={t('pages.patch_note.patch_note_date')}
                        content={data.datePublication}/>
                    <TitleAndContent
                        title={t('pages.patch_note.patch_note_date_update')}
                        content={data.dateModification}/>
                </HStack>
                ...
                <HStack spacing='6rem'>
                    <TitleAndContent
                        title={t('pages.patch_note.patch_note_version')}
                        content={data.version}/>
                    <TitleAndContent
                        title={t('pages.patch_note.patch_note_author')}
                        content={data.auteur}/>
                </HStack>
            </Stack>):(
            ...
            <TitleAndContent
                title={t('pages.patch_note.patch_note_title_article')}
                content={data[`titre${languageCode}`]}/>
            <TitleAndContent
                title={t('pages.patch_note.patch_note_description_article')}
                content={data[`contenu${languageCode}`]}/>
        </TabPanel>
    </>
}