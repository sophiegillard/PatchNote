...
import {
    ...
    FormLabel,
    Input,
    Flex, FormErrorMessage,
    useDisclosure, ButtonGroup, Stack
...
export const AddArticle = () => {
    ...
    return (
        <SidebarWithHeader>
            ...
            <SuccessModal isOpen={successModal.isOpen}
            ...
            <SuccessModal isOpen={draftSuccessModal.isOpen}
            ...
            <BackAndTitle pageTitle={t('pages.patch_note.patch_note_add')}
                          backNavigation={'/patchNote'} />
            ...
            <Stack
                ...
                <form onSubmit={handleSubmit(onSubmitCreateArticle)} >
                    ...
                    <LanguageTabList>
                        <UpdatedTabPanel isArticle={true}
                                         errors={errors}
                                         languageCode={'FR'}
                                         register={register}
                                         control={control} 
                    ...
                    <FormControl id="DatePublication" maxW="20rem" isInvalid={errors.DatePublication}>
                        ...
                        <Input {...register('DatePublication', {
                    ...
                    <FormControl id="ModuleId"  maxW="20rem" isInvalid={errors.ModuleId}>
                        ...
                        <Select
                            ...
                            options={modules && modules.map((module) => ({ value: module.id, label:  t(`filters.filters_modules.list.${module.title}`)  }))}
                        ...
                        <FormErrorMessage>
                                {errors.ModuleId && errors.ModuleId.message}
                        </FormErrorMessage>
                    </FormControl>
                    ...
                    <FormControl id="CategorieId" maxW="20rem" isInvalid={errors.CategorieId}>
                        ...
                        <Select {...register('CategorieId', {
                                ...
                                options={categories && categories.map(categorie => ({ value: categorie.id, label: t(`filters.filters_category.list.${categorie.name}`)}))}
                        ...
                        <FormErrorMessage>
                                {errors.CategorieId && errors.CategorieId.message}
                        </FormErrorMessage>
                    </FormControl>
                    ...
                    <Flex justify="flex-end" direction={{ base: "column", lg: "row" }} alignItems="center">
                        <ButtonGroup gap='2' mt={{ base: "36", sm:"24", md:"24", lg: "16" }} mr={{ base: "0", md: "4" }} >
