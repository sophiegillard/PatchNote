...
import {
    ...
    TabList,
    TabPanel,
    TabPanels, Tabs, Badge, useMediaQuery, Flex, Text, Show, Box,
...
export const IndiviualArticle = () =>{
    ...
    const { data, isLoading, error } = useQuery(["article", id], () =>
    ...
    return(
        <SidebarWithHeader>
            ...
            <BackAndTitle pageTitle={`${t('pages.patch_note.patch_note_show')} ${data.id}`}
            ...
            gap={3}>
                ...
                {data.isBrouillon === 1 &&
                    <HStack spacing='6rem' >
                        <Badge borderRadius="md" fontSize='1em' colorScheme='secondaryPurple'>{t('pages.patch_note.patch_note_status_draft')}</Badge>
                    </HStack>}
