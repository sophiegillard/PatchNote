...
export const UpdateArticle = () =>{
    ...
    return<>
        <SidebarWithHeader>
            ...
            <BackAndTitle pageTitle={`${t('pages.patch_note.patch_note_update')} ${article.id}`}
            ...
            <Stack
                ...
                <FormControl id="DatePublication">
                    ...
                    <Input {...register("DatePublication", { required: true })}
                           type="date"
                ...
                <FormControl id="Version">
                    ...
                    <Input {...register("Version", { required: false })}
                           defaultValue={article.version}/>
