...
import { useNewsletterByIdQuery } from "@/services/newsletter/getNewsletters.js";
...
export const IndividualNewsletter = () => {
    ...
    const { data: thisNewsletter, isLoading, error } = useNewsletterByIdQuery(id);
    ...
    return (
        <>
            <SidebarWithHeader>
                <BackAndTitle
                    pageTitle={`${t("pages.newsletter.newsletter_show")} ${thisNewsletter.id}`}
                ...
                <Stack bgColor="white" borderRadius="lg" p={4}>
                    <LanguageTabList>
