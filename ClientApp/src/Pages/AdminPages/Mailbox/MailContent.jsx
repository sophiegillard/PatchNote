...
export const MailContent = ({   id, ecole, auteur, dateCreation, sujet,
                                statutMessageRecommandation, statutMessageRecommandationId,
                                statutMessageRecommandationColor, message, refetechMessages}) =>{
            ...
            <VStack borderBottom="solid 2px"
                ...
                <HStack justifyContent="space-between"
                    ...
                    <Flex flexDirection="column" gap={1}>
                        <Text fontWeight="bold">{t('pages.mailbox.from')} : {ecole} | {auteur}</Text>
                        <Text >{sujet}</Text>
                    </Flex>
