import { Badge, Flex, HStack, Stack, Text, VStack, useDisclosure, Drawer, DrawerOverlay, DrawerContent, DrawerCloseButton } from "@chakra-ui/react";
...
export const MailContentMobile = ({
    id,
    auteur,
    dateCreation,
    sujet,
                ...
                <DrawerContent bgColor="#f3f3f5">
                    ...
                    <Flex key={id} width="100%" flexDirection="column" alignItems="center" pt={10}>
                        <VStack
                            ...
                            pb={4}
                        >
                            <Flex justifyContent="space-between" flexDirection="row" alignItems="flex-end" gap={1} width="100%" pb={3}>
                        ...
                        <Stack mx={2} py={5} width="90%" overscrollY={"true"} overflow="auto" style={{ maxHeight: "65vh" }}>
