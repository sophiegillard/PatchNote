...
export const LeaveMessage = () => {
    ...
    return (
        <SidebarWithHeader>
            ...
            />
            <Show above="xl">
                <Image src={logo} position={"absolute"}
                                maxWidth={"100%"}
                                height={"30%"}
                                overflow={"hidden"}
                                bottom={0}
                                zIndex={0} p={0} right={"-10"} top="38%"
                                />
            </Show>
            <Container minWidth={{base:"70vw", xl:"60vw"}} zIndex={100} py={10}>
                <Flex zIndex={30} flexDirection={{base:"column", md:"row"}} gap={{base:"4", md:"0"}}>

                    <Center flexDirection="column" align="center" justifyContent={"space-between"}
                            p="4" gap={{base:"8", lg:"2"}} py={{base:"4", lg:"8"}}
                            maxW={{base:"100%", lg:"35%"}}
                        ...
                        <Stack flexGrow={1} gap="4" justifyContent={"center"}>
                            <Text color="White" fontSize={{base:"xl", lg:"2xl"}} fontWeight={"bold"} as='i'>L'équipe est à votre écoute!</Text>
                            <Text as='h5' color="White" fontSize={{base:"", lg:"xl"}} fontWeight={"light"}>Vous avez une idée d’amélioration ou un commentaire pour APSCHOOL?</Text>
                            <Text as='i' fontSize={{base:"", lg:"xl"}}  color="White" fontWeight={"light"}>Partagez-le nous en remplissant ce formulaire.  </Text>
                        </Stack>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <Flex flexDirection={"column"} gap="6">
                                ...
                                <FormControl isInvalid={errors.auteur}>
                                    ...
                                    />
                                    <FormErrorMessage>
                                        {errors.auteur && errors.auteur.message}
                                    </FormErrorMessage>
                                </FormControl>
